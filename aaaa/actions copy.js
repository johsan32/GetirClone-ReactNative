...
//       "https://getir-clone-api.onrender.com/api/discount"
//     );
//     const indirimData = data.data;
//     console.log(indirimData);
//     const newdata = Math.min(indirimData, 20); // En fazla 50 ile sınırlandırma
...
export const getSuIcecek = () => {
  return async (dispatch) => {
    ...
    const newdata = Math.min(suIcecek, 20); 
